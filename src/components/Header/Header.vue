<template>
    <v-app-bar class="main-header" height="64" fixed color="primary" dark>
        ...
        <v-spacer></v-spacer>
        <v-btn href="https://flatlogic.com/templates/vue-material-template-full/demo" class="d-none d-sm-flex mr-5" outlined color="error"> Unlock Full Version</v-btn>
        <Search />
        ...
        <v-menu max-width="280" offset-y bottom nudge-bottom="10" left>
            <template v-slot:activator="{ on, attrs }">
                <v-btn @click="messageBadge ? (messageBadge = !messageBadge) : ''" v-bind="attrs" v-on="on" style="font-size: 28px" icon class="mr-2">
